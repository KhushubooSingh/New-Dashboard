        ...
        <div class="leftside-menu">
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                ...
                <ul class="side-nav">
                            ...
                            <div class="collapse" id="sidebarPagesAuth">
                                <ul class="side-nav-second-level">
                                    <li>
                                        ...
                                        <li><a href="auth-emp-registration.php">Employee Registration</a></li>
                                        <li><a href="auth-emp-login.php">Update Exsisting</a></li>
                                    </li>
                                    <li>
                                    ...
                                    <li> 
                                        <a href="auth-login-task.php">Task Management</a>
                                    </li>
                                    <li> 
                                        <a href="auth-emp-task-access.php">Employee Login</a>
                                    </li>
                                    <li>
                    ...
                    <li class="side-nav-item">
                        <a href="auth-login-task.php" class="side-nav-link">
                    ...
                    <li class="side-nav-item">
                        <a href="auth-emp-task-access.php" class="side-nav-link">
                    ...
                    <li class="side-nav-item">
                        <a href="auth-verification.php" class="side-nav-link">
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">IITK</a></li>
