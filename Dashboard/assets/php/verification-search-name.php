    ...
    <div class="container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<div class='alert text-center' style='background: radial-gradient(circle, rgba(247,247,247,1) 0%, rgba(124,150,172,1) 34%);''>No results found for the name: " . htmlspecialchars($name) . "</div>";
            }
